...
description: "Cet article présente un algorithme performant permettant la transformation d'un résultat SQL sous forme de tableau à sa représentation JSON sous forme d'arbre"
---
